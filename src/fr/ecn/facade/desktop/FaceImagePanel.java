...
public class FaceImagePanel extends ImagePanel implements MouseListener, MouseMotionListener {
	...
	public FaceImagePanel(Image image, FaceController controller) {
		super(image);
